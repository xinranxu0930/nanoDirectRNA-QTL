...
if __name__ == "__main__":
    ...
    if args.motif:
        read_m6A_set = get_read_modify_motif(args.bam,args.mod_threshold,args.min_qscore,args.threads,args.strand)
        n = "_motif"
    else:
        read_m6A_set = get_read_modify_base(args.bam,args.mod_threshold,args.min_qscore,args.threads,args.strand)
        n = ""

    read_m6A_file = f"{args.dir_pre}_read_m6A_pos_{'f' if args.strand == '+' else 'r'}{n}_tmp.txt"
