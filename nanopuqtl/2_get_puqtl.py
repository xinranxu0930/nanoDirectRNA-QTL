...
# fisher
def simulate_fisher_exact_se(A1_promoter1, A2_promoter1, A1_promoter2, A2_promoter2):
...
def apply_simulate_fisher(row):
    return simulate_fisher_exact_se(row['A1_promoter1'], row['A2_promoter1'], row['A1_promoter2'], row['A2_promoter2'])
